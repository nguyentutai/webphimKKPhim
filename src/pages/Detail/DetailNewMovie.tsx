...
const DetailNewMovie = () => {
    ...
    const checkMovies = movies?.episodes[0].server_data.length;
    console.log(movies?.episodes[0].server_data.length)
    if (checkMovies > 1) {
        return (
